...
- (void)viewDidLoad
{
    ...
    MHGalleryItem *landschaft11 = [MHGalleryItem.alloc initWithURLString:@"http://www.bestfon.info/images/joomgallery/originals/paisajes_18/paisaje_325_20120501_1124813185.jpg"
                                                        galleryType:MHGalleryTypeImage];
    MHGalleryItem *landschaft12 = [MHGalleryItem.alloc initWithURLString:@"http://www.stadt-bad-reichenhall.de/medien/landschaft-winter-1.jpg"
                                                        galleryType:MHGalleryTypeImage];
    MHGalleryItem *landschaft13 = [MHGalleryItem.alloc initWithURLString:@"http://www.foto-zumstein.ch/fotogalerie/1195564506_Kopie_vonLandschaft_33.jpg"
                                                        galleryType:MHGalleryTypeImage];
    MHGalleryItem *landschaft14 = [MHGalleryItem.alloc initWithURLString:@"http://img.galerie.chip.de/imgserver/communityimages/233900/233952/1280x.jpg"
                                                        galleryType:MHGalleryTypeImage];
    MHGalleryItem *landschaft15 = [MHGalleryItem.alloc initWithURLString:@"http://www.spreephoto.de/wp-content/uploads/2011/03/toskana-strohballen-landschaft.jpg"
                                                        galleryType:MHGalleryTypeImage];
    MHGalleryItem *landschaft16 = [MHGalleryItem.alloc initWithURLString:@"http://kwerfeldein.de/wp-content/uploads/2012/07/landschaft.jpg"
                                                        galleryType:MHGalleryTypeImage];

    MHGalleryItem *landschaft17 = [MHGalleryItem.alloc initWithURLString:@"http://www.picspack.de/blog/wp-content/uploads/2011/11/Liu2.jpg"
                                                        galleryType:MHGalleryTypeImage];

    MHGalleryItem *landschaft18 = [MHGalleryItem.alloc initWithURLString:@"http://images.fotocommunity.de/bilder/bach-fluss-see/see-teich-tuempel/symmetrische-landschaft-645f1ee5-f53b-4ae9-ad76-7bf5bde3935d.jpg"
                                                        galleryType:MHGalleryTypeImage];

    MHGalleryItem *landschaft19 = [MHGalleryItem.alloc initWithURLString:@"http://www.hd-gbpics.de/gbbilder/landschaften/landschaft10.jpg"
                                                        galleryType:MHGalleryTypeImage];

    MHGalleryItem *landschaft20 = [MHGalleryItem.alloc initWithURLString:@"http://www.stadt-bad-reichenhall.de/medien/landschaft-1.jpg"
                                                        galleryType:MHGalleryTypeImage];
    
    MHGalleryItem *landschaft21 = [MHGalleryItem.alloc initWithURLString:@"http://i.imgur.com/qe8wIgn.gif"
                                                        galleryType:MHGalleryTypeImage];
